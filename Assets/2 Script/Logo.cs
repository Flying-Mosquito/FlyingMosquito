...
public class Logo : MonoBehaviour {
  //  public Image Image_Star;
    ...
    IEnumerator Start()
    {
        ...
        //yield return new WaitForSeconds(0.3f);
        //Image_StarSailor.DOFade(0.3f, 0.1f);// DOFade(1, 5.0f);
        //yield return new WaitForSeconds(0.1f);
        //Image_StarSailor.DOFade(1.0f, 0.1f);
        //yield return new WaitForSeconds(0.5f);

        Image_StarSailor.DOFade(1.0f, 2f);
        //yield return StartCoroutine(Fill_Image(Image_StarSailor, 0.2f));
